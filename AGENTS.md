...
**Codex Desktop** — prompt materials exist and are packaged, and the repo now holds no hardcoded absolute paths at all. The scheduled task itself is still created separately in Codex Desktop.
